...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['What the dog doin', 0.2], //From 0% to 19%
		['Shit', 0.4], //From 20% to 39%
		['Bad', 0.5], //From 40% to 49%
		['stupid bitch', 0.6], //From 50% to 59%
		['8 years old kid lol', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['YEAH', 0.8], //From 70% to 79%
		['+15 MEDIA CREDIT', 0.9], //From 80% to 89%
		['YOOOOOOO', 1], //From 90% to 99%
		['Yaaah', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
